...
def setup_training_loop_kwargs():
    ...
    args.G_kwargs = dnnlib.EasyDict(
        class_name="training.networks_GS.Generator",
        z_dim=512,
        w_dim=512,
    ...
    args.loss_kwargs = dnnlib.EasyDict(
        class_name="training.loss_GCC_pretrain.StyleGAN2Loss", r1_gamma=spec.gamma
    )
    ...
    if args.sparsity_lambda is None:
        args.sparsity_lambda = 0.0
    args.sparsity_lambda = float(args.sparsity_lambda)
    assert isinstance(args.sparsity_lambda, float)
    args.loss_kwargs.sparsity_lambda = args.sparsity_lambda
