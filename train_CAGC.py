...
from main_utils_CAGC import setup_training_loop_kwargs, print_time
from training import training_loop_CAGC
...
def subprocess_fn(rank, args, temp_dir):
    ...
    training_loop_CAGC.training_loop(rank=rank, **vars(args))
