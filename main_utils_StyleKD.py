...
def setup_training_loop_kwargs():
    ...
    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks_StyleKD.Generator', z_dim=512, w_dim=512, mapping_kwargs=dnnlib.EasyDict(), synthesis_kwargs=dnnlib.EasyDict())
    args.D_kwargs = dnnlib.EasyDict(class_name='training.networks_StyleKD.Discriminator', block_kwargs=dnnlib.EasyDict(), mapping_kwargs=dnnlib.EasyDict(), epilogue_kwargs=dnnlib.EasyDict())
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss_StyleKD.StyleGAN2Loss', r1_gamma=spec.gamma)
    ...
    # ---------------------------------------------------
    # Content Aware GAN Compression settings: teacker_ckpt, student_ckpt, kd_percept_mode, kd_percept_lambda, kd_l1_mode, kd_l1_lambda, pruning_ratio
    # ---------------------------------------------------
