...
def setup_training_loop_kwargs():
    ...
    args.D_teacher_opt_kwargs = dnnlib.EasyDict(class_name="torch.optim.Adam", lr=spec.lrate, betas=[0,0.99], eps=1e-8)
    ...
    args.loss_kwargs.class_name = 'training.loss_DD.StyleGAN2Loss'
    ...
    args.G_kwargs.class_name = 'training.networks_DD.Generator'
    ...
    args.D_kwargs.class_name = "training.networks_DD.Discriminator"
