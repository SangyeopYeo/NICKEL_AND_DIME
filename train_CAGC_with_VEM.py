...
from main_utils_CAGC_with_VEM import setup_training_loop_kwargs, print_time
from training import training_loop_CAGC_with_VEM
...
def subprocess_fn(rank, args, temp_dir):
    ...
    training_loop_CAGC_with_VEM.training_loop(rank=rank, **vars(args))
