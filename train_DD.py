...
from main_utils_DD import setup_training_loop_kwargs, print_time
from training import training_loop_DD
...
def subprocess_fn(rank, args, temp_dir):
    ...
    training_loop_DD.training_loop(rank=rank, **vars(args))
