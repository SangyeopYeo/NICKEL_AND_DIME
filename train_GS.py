...
from main_utils_GS import setup_training_loop_kwargs, print_time
from training import training_loop_GS
...
def subprocess_fn(rank, args, temp_dir):
    ...
    training_loop_GS.training_loop(rank=rank, **vars(args))
